...
void TCPMessengerClient::run()
{
	...
	while (runningNormaly)
	{
		...
		switch (Command)
		{
			...
			{
				displayUsersListReply(client);
				break;
			}
			case PRINT_USER_CONNECTED:
			{
				displayConnUsersReply(client);
				break;
			}
			case OPEN_SESSION_WITH_PEER:
			{
				createSessionWithPeerReply(client);
				break;
			}
			case CREATE_CHAT_ROOM:
			{
				openChatRoomReply(client);
				break;
			}
			case PRINT_CHAT_ROOM:
			{
				displayChatRoomsReply(client);
				break;
			}
			case OPEN_SESSION_WITH_CHAT_ROOM:
			{
				joinSessionWithCrReply(client);
				break;
			}
			case ERASE_MSG:
			{
 ...
 */
void TCPMessengerClient::openChatRoomReply(TCPSocket *cSocket)
{
 ...
 */
void TCPMessengerClient::createSessionWithPeerReply(TCPSocket *cSocket)
{
 ...
 */
void TCPMessengerClient::displayConnUsersReply(TCPSocket *cSocket)
{
 ...
 */
void TCPMessengerClient::displayUsersListReply(TCPSocket *cSocket)
{
	int length = this->readLength(cSocket);
	TCPMessengerProtocol::readFromSocket(length , cSocket);
}
 ...
 */
void TCPMessengerClient::signUpReply(TCPSocket *cSocket)
{
 ...
 */
void TCPMessengerClient::logInReply(TCPSocket *cSocket)
{
	string msg = TCPMessengerProtocol::readData(cSocket);
	cout<<msg<<endl;
 ...
 */
void TCPMessengerClient::displayChatRoomsReply(TCPSocket *cSocket)
{
	int length = this->readLength(cSocket);
	TCPMessengerProtocol::readFromSocket(length , cSocket);
}
 ...
 */
void TCPMessengerClient::joinSessionWithCrReply(TCPSocket *cSocket)
{
	int length = this->readLength(cSocket);
	...
	withUser = "NONE";
	session = "IN";
	cout<<"A new client has joined the chat room"<<endl;
}

/*
 * Deletes all users in the room and prints status
 */
void TCPMessengerClient::exitFromRoomReply(TCPSocket *cSocket)
{
 ...
 */
void TCPMessengerClient::closeRoomReply()
{
	this->deleteAllusersInSession();
	chatRoom = "NONE";
	session = "OUT";
 ...
 */
void TCPMessengerClient::eraseMsgReply()
{
	this->deleteAllusersInSession();
	chatRoom = "NONE";
	session = "OUT";
 ...
 */
void TCPMessengerClient::closeSessionWithPeerReply()
{
	this->deleteAllusersInSession();
	chatRoom = "NONE";
	session = "OUT";
